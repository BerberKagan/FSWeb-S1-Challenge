...
function indekseGoreFenomen (dizi, sayi) {
  ...
  let x = sayi;
  let y = '. indekste bulunan fenomen: '; 
  let z = dizi[sayi].profile;
...
function fenomenGonderimSayisi (dizi, username) {
  
  for (let i = 0; i < dizi.length; i++) {
    
    if (dizi[i].profile === username) {
